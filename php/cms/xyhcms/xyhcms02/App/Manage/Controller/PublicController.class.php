...
class PublicController extends CommonController {
	...
	Public function main() {
		...
		/* __PUBLIC__/uploads */
		$this->assign('environment_upload', ini_get('file___PUBLIC__/uploads') ? ini_get('upload_max_filesize') : '不支持');
	...
	Public function browseFile($spath = '', $stype = 'file') {
		$base_path  = '__PUBLIC__/images/uploads/img1';
		...
		case 'picture':
			...
			break;
		case 'file':
			$base_path = '__PUBLIC__/images/uploads/file1';
			//$where     = array('file_type' => array('NEQ', 1));
			$where = array('has_litpic' => 0);
			break;
		case 'ad':
			$base_path = '__PUBLIC__/images/uploads/abc1';
