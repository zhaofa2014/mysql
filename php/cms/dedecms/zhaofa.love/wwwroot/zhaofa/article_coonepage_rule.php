    ...
    <form name='addform' action='article_coonepage_rule.php' method='post'>
        ...
        <table width="430" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td width="302"><input name="title" type="text" id="title" style="width:200px"
                                       value="<?php echo $row['title']; ?>"/></td>
                <td width="26" align="center"><a href="javascript:CloseEditNode()"><img src="images/close.gif"
                                                                                        width="12" height="12"
                                                                                        border="0"/></a></td>
            </tr>
            <tr>
                ...
                <td colspan="2">
                    <input type="radio" name="lang"
                           value="gb2312" <?php echo($row['lang'] == 'gb2312' ? ' checked="checked" ' : ''); ?> />
                    GB2312/GBK
                    <input type="radio" name="lang"
                           value="utf-8" <?php echo($row['lang'] == 'utf-8' ? ' checked="checked" ' : ''); ?> />
                    UTF-8
                </td>
            </tr>
            <tr>
                ...
                <td colspan="2">
                    <input type="radio" name="issource"
                           value="0" <?php echo($row['issource'] == 0 ? ' checked="checked" ' : ''); ?> />
                    否
                    <input name="issource" type="radio"
                           value="1" <?php echo($row['issource'] == 1 ? ' checked="checked" ' : ''); ?> />
                    是
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td height="90">&nbsp;</td>
                <td colspan="2"><textarea name="rule"
                                          style="width:300px;height:80px"><?php echo $row['rule']; ?></textarea></td>
            </tr>
            <tr>
                <td height="32">&nbsp;</td>
