...
(function ($) {
    ...
    $.widget("ui.resizable", $.extend({}, $.ui.mouse, {
        init: function () {
            ...
            if (o._nodeName.match(/canvas|textarea|input|select|button|img/i)) {
                ...
                this.element.css({
                    marginLeft: oel.css("marginLeft"), marginTop: oel.css("marginTop"),
            ...
            if (o.handles.constructor == String) {
                ...
                for (var i = 0; i < n.length; i++) {
                    var handle = $.trim(n[i]), dt = o.defaultTheme, hname = 'ui-resizable-' + handle,
    ...
    $.ui.plugin.add("resizable", "grid", {
        ...
        resize: function (e, ui) {
            var o = ui.options, self = $(this).data("resizable"), cs = self.size, os = self.originalSize,
                op = self.originalPosition, a = self.axis, ratio = o._aspectRatio || e.shiftKey;
        ...
        resize: function (e, ui) {
            ...
            var delta = {
                ...
                _alsoResize = function (exp, c) {
                    $(exp).each(function () {
                        var start = $(this).data("resizable-alsoresize"), style = {},
