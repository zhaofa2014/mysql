...
if (!empty($cfg_ml->M_ID)) {
    ...
    <div id="mcpsub">
        ...
        <div id="menuBody">
            ...
            if ($menutype == 'content') {
                ...
                <ul id="menuFirst">
                    ...
                    if ($channelInfos['article']['issend'] == 1 && $channelInfos['article']['isshow'] == 1) {
                        ?>
                        <li class="articles"><a href="../member/content_list.php?channelid=1"
                                                title="已发布的文章"><b></b>文章</a><a href="../member/article_add.php"
                                                                               class="act" title="发表新文章">发表</a></li>
                        <?php
                    }
                    //是否启用图集投稿
                    if ($channelInfos['image']['issend'] == 1 && $cfg_mb_album == 'Y' && $channelInfos['image']['isshow'] == 1
                        ...
                        <li class="photo"><a href="../member/content_list.php?channelid=2" title="管理图集"><b></b>图集</a><a
                                    href="../member/album_add.php" class="act" title="新建图集">新建</a></li>
                        <?php
                    }
                    //是否启用软件投稿
                    if ($channelInfos['soft']['issend'] == 1 && $channelInfos['soft']['isshow'] == 1
                        ...
                        ?>
                        <li class="soft"><a href="../member/content_list.php?channelid=3" title="已发布的软件"><b></b>软件</a><a
                                    href="../member/soft_add.php" title="上传软件" class="act">上传</a></li>
                        <?php
                    }
                    ?>
                </ul>
                ...
                if ($cfg_mb_sendall == 'Y') {
                    ...
                    foreach ($add_channel_menu as $nnarr) {
                        ?>
                        <li class="<?php echo $nnarr['nid']; ?>"><a
                                    href="../member/<?php echo $nnarr['list']; ?>?channelid=<?php echo $nnarr['id']; ?>"
                                    title="已发布的<?php echo $nnarr['typename']; ?>"><b></b><?php echo $nnarr['typename']; ?>
                            </a><a href='archives_do.php?dopost=addArc&channelid=<?php echo $nnarr['id']; ?>'
                                   class="act" title="发表新文章">发表</a></li>
                        <?php
                    }
                }
            ...
            if ($menutype == 'mydede') {
                ...
                <ul id="menuFirst">
                    ...
                    while ($nnarr = $dsql->GetArray('nn')) {
                        ...
                        ?>
                        <li class="<?php echo $nnarr['class']; ?>"><a
                                    href="<?php echo $nnarr['indexurl']; ?>"><b></b><?php echo $nnarr['indexname']; ?>模块</a>
                        </li>
                        <?php
                    }
                    ?>
            ...
            if ($menutype == 'config') {
                ?>
                <h2 class="menuTitle" onclick="menuShow('menuFirst')" id="menuFirst_t">
                    <b></b><?php echo $cfg_ml->M_MbType; ?>资料</a></h2>
                <ul id="menuFirst">
                    <li class="icon baseinfo"><a href="../member/edit_baseinfo.php"><b></b>基本资料</a></li>
                    <li class="icon myinfo"><a
                                href="../member/edit_fullinfo.php"><b></b><?php echo $cfg_ml->M_MbType; ?>资料</a></li>
