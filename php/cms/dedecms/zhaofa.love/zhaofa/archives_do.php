...
------------------------------*/
    ...
    <tr height='32'>
        ...
        <td class='bline'>
            <input name="shorttitle" type="text" id="shorttitle" value="<?php echo $arcRow['shorttitle']; ?>"
                   style="width:60%"/>
        </td>
    </tr>
    <tr height='32'>
    ...
    <tr height='32'>
        ...
        <td class='bline'>
            <input name="keywords" type="text" id="keywords" value="<?php echo $arcRow['keywords']; ?>"
                   style="width:70%"/>
        </td>
    </tr>
    <tr height='32'>
...
-------------------------*/
    ...
    <form name='quicksel' action='javascript:;' method='get'>
        ...
        <div align='center' class='quickselfoot'>
            <img src="images/button_ok.gif" onclick="getSelCat('<?php echo $targetid; ?>');" width="60" height="22"
                 class="np" border="0" style="cursor:pointer"/>
            &nbsp;&nbsp;
            <img src="images/button_back.gif" onclick='HideObj("<?php echo $divname; ?>");ChangeFullDiv("hide");'
                 width="60" height="22" border="0" style="cursor:pointer"/>
        </div>
    </form>
    <?php
//AJAX窗体结束
