    ...
    <form name='editform' action='group_store.php' method='get'>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td width="101"><input name="storename" type="text" id="storename"
                                       value="<?php echo $row['storename']; ?>"/></td>
            ...
            <tr>
                ...
                <td colspan="2"><input name="orders" type="text" id="orders" size="5"
                                       value="<?php echo $row['orders']; ?>"/>
                    （数值小靠前）
                </td>
            </tr>
            <tr>
                <td height="43">&nbsp;</td>
                <td colspan="2"><input type="submit" name="Submit" value="保存更改" class="np coolbg" style="width:80px"/>
                </td>
            </tr>
        </table>
    </form>
