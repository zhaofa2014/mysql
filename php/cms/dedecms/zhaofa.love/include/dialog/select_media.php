    ...
    <tr bgcolor='#FFFFFF'>
        <td colspan='3'>
            ...
            <table width='100%' border='0' cellspacing='0' cellpadding='2'>
                <tr bgcolor="#CCCCCC">
                    <td width="55%" align="center" background="img/wbg.gif" class='linerow'><strong>点击名称选择文件</strong>
                    </td>
   ...
   <td align='center' class='linerow' bgcolor='#F9FBF0'>$filetime</td>
                ...
                <tr>
                    <td colspan='3' bgcolor='#E8F1DE'>
                        ...
                        <table width='100%'>
                            <form action='select_media_post.php' method='POST' enctype="multipart/form-data"
                                  name='myform'>
                                ...
                                <tr>
                                    <td background="img/tbg.gif" bgcolor="#99CC00">
                                        &nbsp;上　传： <input type='file' name='uploadfile' style='width:320px'>&nbsp;<input
                                                type='submit' name='sb1' value='确定'>
                                    </td>
                                </tr>
                            </form>
                        </table>
