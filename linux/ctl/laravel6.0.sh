...
cd /www/wwwroot
rm -rf laravel.zhaofa.love
composer create-project --prefer-dist laravel/laravel laravel.zhaofa.love v6.0.0
cd laravel.zhaofa.love
...
-p 8888:8888 \
-p 9501:9501 \
1872220587/bt:centos7.6.1810..Bt7.0.12..tp5.1..v5.0
docker exec -it tp5.1 /bin/bash   #使用
bt 1
#服务启动
...
docker commit  -a "1872220587" -m "tp5.1学习" tp5.1 1872220587/bt:centos7.6.1810..Bt7.0.12..tp5.1..v5.0   #提交
#docker stop tp5.1  #停止
#docker rm tp5.1    #删除
docker push 1872220587/bt:centos7.6.1810..Bt7.0.12..tp5.1..v5.0   #上传
